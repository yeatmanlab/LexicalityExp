...
datadir = '/home/stone-ext1/fmridata/20160229-ST001-E004/';
...
% it is okay if you also match things that are not DICOM directories; we'll just ignore them.
epifilenames = matchfiles([datadir '/MR*cmrr*bold*']);
...
episliceorder = {};
episliceorder{1} = [1 12 23 10 21 8 19 6 17 4 15 2 13 24 11 22 9 20 7 18 5 16 3 14 1 12 23 10 21 8 19 6 17 4 15 2 13 24 11 22 9 20 7 18 5 16 3 14 1 12 23 10 21 8 19 6 17 4 15 2 13 24 11 22 9 20 7 18 5 16 3 14];
episliceorder{2} = 1.000255;
...
epireadouttime = 0.67 * (104*7/8/2);  % divide by 2 if you are using 2x acceleration
epireadouttime = 0.67 * (104/2);  % divide by 2 if you are using 2x acceleration
  % 104 is the EPI factor
...
mcmask = {};
mcmask = { [0.5 0.5 0.58] [0.32 0.3 0.38];};
